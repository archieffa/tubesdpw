        ...
        <table class="table custom-table">
		  ...
		  foreach ($data as $dtm){
			...
			<tr>
				...
				<td><?php echo $dtm->name_cust_booking;?></td>
				<td><?php echo $dtm->check_in_booking;?></td>
				<td><?php echo $dtm->check_out_booking;?></td>
				<td><?php echo $dtm->guests_booking;?></td>
				<td><?php echo $dtm->room_booking;?></td>
				<td><?php echo $dtm->pilihan_bayar;?></td>
				<td><a href="<?php echo base_url('C_BlueMoon/AksiDeleteBooking/').$dtm->id_booking;?>">Delete</a></p></td>
		  </tr>
		  <?php
		  $nomor++;
		  }
