            ...
            <div class="row">
                <div class="col-lg-4">
                    <div class="contact-text">
                        <h2>Kontak</h2>
                        <p>Hubungi kami melalui info dibawah ini</p>
                        <table>
                            <tbody>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td>(+62) 851-7898-1265</td>
                                </tr>
                                <tr>
                                    <td class="c-o">Email:</td>
                                    <td>bluemoon@gmail.com</td>
                                </tr>
                                <tr>
				...
				<form action="<?php echo site_url ('C_BlueMoon/tambahcontact')?>" method ="post" class="contact-form">
                        <div class="row">
                            <div class="col-lg-6">
